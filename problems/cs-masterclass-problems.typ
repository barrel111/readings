...
+ Consider, \ $ 
sum_(i,j,k = 1)^n a_(i j)^(1/2) b_(j k)^(1/2) c_(k i)^(1/2) &= sum_(i, j = 1)^n a_(i j)^(1/2) sum_(k = 1)^n b_(j k)^(1/2) c_(k i)^(1/2) \ &<= sum_(i, j = 1)^n a_(i j)^(1/2) (sum_(k = 1)^n b_(j k))^(1/2) (sum_(k = 1)^n c_(k i))^(1/2) \ &= sum_(j = 1)^n (sum_(k = 1)^n b_(j k))^(1/2) sum_(i = 1)^n a_(i j)^(1/2) (sum_(k = 1)^n c_(k i))^(1/2) \ &<= (sum_(i, k = 1)^n c_(k i))^(1/2) sum_(j = 1)^n (sum_(k = 1)^n b_(j k))^(1/2) (sum_(i = 1)^n a_(i j))^(1/2) \ &<= (sum_(i, j = 1)^n a_(i j))^(1/2) (sum_(j, k = 1)^n b_(j k))^(1/2) (sum_(i, k = 1)^n c_(k i))^(1/2). $

+ Let $n = max_(bold(x) in A) norm(bold(x))_oo. $ Then let $ a_(i j) = bb(1) {(0, j, k) in A_x}, \ b_(i j) = bb(1) {(i, 0, k) in A_y}, \ c_(i j) = bb(1) {(i, j, 0) in A_z}. $ \ Note that $a_(i j)^(1/2) b_(j k)^(1/2) c_(k i)^(1/2) = a_(i j) b_(j k) c_(k i) in {0, 1}$. Furthermore, $a_(i j) b_(j k) c_(k i) = 1$ if and only if $(i, j, k) in A$. Thus, $ |A| = sum_(i, j, k = 1)^n a_(i j)^(1/2) b_(j, k)^(1/2) c_(k i)^(1/2) <=  (sum_(i, j = 1)^n a_(i j))^(1/2) (sum_(j, k = 1)^n b_(j k))^(1/2) (sum_(i, k = 1)^n c_(k i))^(1/2) = |A_x|^(1/2) |A_y|^(1/2) |A_z|^(1/2). $
